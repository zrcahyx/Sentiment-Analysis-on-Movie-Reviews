...
flags.DEFINE_float('beta', 0.05, 'The regularization term for l2 norm.')
flags.DEFINE_integer('lstm_units', 100, 'lstm output units.')
flags.DEFINE_integer('cnn_flag', 1, 'Use cnn feature or not.')
flags.DEFINE_integer('cnn_kernels', 128, 'How many filters to use for CNN.')
flags.DEFINE_string('cnn_ngrams', '3,4,5', 'cnn filter size.')
flags.DEFINE_integer('rnn_flag', 0, 'Use rnn feature or not.')
